...
<div class="panel panel-default">
	<div class="panel-heading">
		<form class="form-inline">
			...
			<div class="form-group">
				<a class="btn btn-danger" href="?m=kasus_tambah"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
			</div>
		</form>
	</div>
		...
		<table class="table table-bordered table-hover table-striped">
			...
			foreach ($rows as $row) : ?>
				<tr>
					...
					<td class="nw">
						<a class="btn btn-xs btn-success" href="?m=kasus_ubah&ID=<?= $row->kode_kasus ?>"><span class="glyphicon glyphicon-edit"></span></a>
