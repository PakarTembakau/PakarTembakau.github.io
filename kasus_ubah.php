    ...
    <div class="col-sm-6">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="kode_kasus" value="<?= $kasus->kode_kasus ?>" readonly />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-danger" href="?m=kasus"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
            </div>
        </form>
    </div>
</div>